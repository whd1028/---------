...
def time_test(d, budget):
    start = time.time_ns()
    solution1(d, budget)
    # solution1_time = time.time_ns() - start
    print(f"{time.time_ns()=}, {start=}")

    start = time.time_ns()
    solution2(d, budget)
    # solution2_time = time.time_ns() - start
    print(f"{time.time_ns()=}, {start=}")

    # print(f"{solution1_time=}, {solution2_time=}")
