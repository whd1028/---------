...
# 그렇기 때문에 네오는 기억한 멜로디를 [재생 시간]과 제공된 [악보]를 직접 보면서 비교하려고 한다. 
...
# musicinfos는 100개 이하의 곡 정보를 담고 있는 배열로, 각각의 곡 정보는 [음악이 시작한 시각, 끝난 시각, 음악 제목, 악보 정보]가 ','로 구분된 문자열이다.
...
def test():
    assert solution1("ABCDEFG", ["12:00,12:14,HELLO,CDEFGAB", "13:00,13:05,WORLD,ABCDEF"]) == "HELLO"
    assert solution1("CC#BCC#BCC#BCC#B",["03:00,03:30,FOO,CC#B", "04:00,04:08,BAR,CC#BCC#BCC#B"]) == "FOO"
    assert solution1("ABC", ["12:00,12:14,HELLO,C#DEFGAB", "13:00,13:05,WORLD,ABCDEF"]) == "WORLD"
...
def solution1(m, musicinfos):
    ...
    for i in set(re.findall("[CDEFGA]#", m)):
