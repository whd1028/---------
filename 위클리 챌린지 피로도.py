...
def test():
    assert solution1(80, [[80,20],[50,40],[30,10]]) == 3
...
Yoon_Eung_gu_solution = lambda k, d: max([Yoon_Eung_gu_solution(k - u, d[:i] + d[i+1:]) + 1 for i, (m, u) in enumerate(d) if k >= m] or [0])
