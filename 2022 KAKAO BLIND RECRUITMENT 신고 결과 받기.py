...
def test():
    assert solution2(["muzi", "frodo", "apeach", "neo"], ["muzi frodo","apeach frodo","frodo neo","muzi neo","apeach muzi"], 2) == [2,1,1,0]
    assert solution2(["con", "ryan"], ["ryan con", "ryan con", "ryan con", "ryan con"], 3) == [0,0]
